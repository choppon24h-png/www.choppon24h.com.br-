...
export const franchiseLeads = mysqlTable("franchiseLeads", {
  id: int("id").autoincrement().primaryKey(),
  ...
  investmentRange: varchar("investmentRange", { length: 40 }).notNull(),
  preferredModel: varchar("preferredModel", { length: 40 }).notNull(),
